	...
	<ul class="list-unstyled">
		...
		foreach ( $show->result_array () as $had ) {
			...
			<li>
				<article>
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo $i;?>. <a href="<?php echo  site_url () . 'tema/' . imam_id ( $had [field ( "imam_id" )] ) . '/' . $had [field ( "bab_imam_id" )] ;?>" class="tooltip-bab" title="<?php echo  $had ['bab_indonesia'] ?>">Bab <?php echo $had ['bab_indonesia']?></a></h3>
						</div>
				...
				<?php
			echo '<p><strong>' . $highlite_string . '</strong></p>  
